...
{
    public partial class InitisialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContavtInfoId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarOwners", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarOwners_ContactsInfo_ContavtInfoId",
                        column: x => x.ContavtInfoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarOwners_ContavtInfoId",
                table: "CarOwners",
                column: "ContavtInfoId");
